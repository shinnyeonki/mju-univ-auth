...
표준 SSO 인증기
===============
명지대학교 표준 SSO 인증을 처리하는 클래스입니다.
MSI, LMS, Portal, MyiCAP 등 대부분의 서비스에서 사용됩니다.
"""
...
class StandardAuthenticator(BaseAuthenticator):
    ...
    RSA/AES 암호화 기반의 SSO 로그인 프로세스를 구현합니다.
    """
    ...
    def _execute_login(self, session: requests.Session):
        """
        실제 SSO 로그인 로직
